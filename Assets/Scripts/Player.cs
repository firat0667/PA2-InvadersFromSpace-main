...
public class Player : MonoBehaviour
{
    ...
    // const deðer sabit kalýcaksa deðiþmicekse kullanýlýr 
    bool isShooting;
    //float coolDown = 0.5f;
    ...
    void Update()
    {
        ...
        // mobile de  telefonu saða sola rotate ettýgýmýzde sag sola hareket saglanýyor gvro sensör ile  hareket saglandý
        //Debug.Log(dirx);
